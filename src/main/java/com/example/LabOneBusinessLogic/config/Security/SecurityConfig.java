package com.example.LabOneBusinessLogic.config.Security;

import com.example.LabOneBusinessLogic.Security.Filters.JaasStartFilter;
import com.example.LabOneBusinessLogic.Security.Jaas.JaasAuthorityGranter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    DefaultJaasAuthenticationProvider jaasAuthenticationProvider() {
        AppConfigurationEntry appConfig = new
                AppConfigurationEntry("com.example.LabOneBusinessLogic.Security.Jaas.JaasLoginModule",
